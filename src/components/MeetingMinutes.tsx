...
import { downloadMinuteHtml } from '../collaboration/meetingMinutes';

export default function MeetingMinutes({ minutes }: { minutes: MeetingMinute[] }) {
